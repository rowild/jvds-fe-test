<template>
  <q-page padding class="flex flex-center column inset-8 border-4 border-red-500">
...
const indexPageTL = gsap.timeline({
  paused: true,
  onStart: () => {
    console.info('IndexPage GSAP timeline onStart invoked')
  },
  onComplete: () => {
    console.info('IndexPage GSAP timeline onComplete invoked')
  }
})
